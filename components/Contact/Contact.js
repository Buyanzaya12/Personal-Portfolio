...
export function Contact() {
    ...
    <div className="grid grid-rows-6 text-center">
                ...
                <div className="grid grid-cols-3 w-screen flex justify-center">
                ...
                <div className="grid grid-cols-3 m-0">
                    ...
                    <div className="text-4xl 4xl:text-base md:text-lg lg:text-xl xl:text-2xl font-semibold">+91 8980500565</div>
                    <div><Image src="/PP-pics/files.svg" width={44} height={44} /></div>
                </div>
